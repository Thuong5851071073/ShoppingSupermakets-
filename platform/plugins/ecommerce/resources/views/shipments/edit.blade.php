...
@section('content')
    <div class="max-width-1200">
        @if ($shipment->status == \Platform\Ecommerce\Enums\ShippingStatusEnum::CANCELED)
                            ...
                            <div class="dropdown dropdown-menu dropdown-ps-left applist-style animate-scale-dropdown min-width-200-px" role="menu" aria-labelledby="dropdownfilter">
                                <div>
                                    <ul class="applist-menu">
                                        <li><a data-value="{{ \Platform\Ecommerce\Enums\ShippingStatusEnum::PICKING }}" data-target="{{ route('ecommerce.shipments.update-status', $shipment->id) }}">{{ \Platform\Ecommerce\Enums\ShippingStatusEnum::PICKING()->label() }}</a></li>
                                        <li><a data-value="{{ \Platform\Ecommerce\Enums\ShippingStatusEnum::DELIVERING }}" data-target="{{ route('ecommerce.shipments.update-status', $shipment->id) }}">{{ \Platform\Ecommerce\Enums\ShippingStatusEnum::DELIVERING()->label() }}</a></li>
                                        <li><a data-value="{{ \Platform\Ecommerce\Enums\ShippingStatusEnum::DELIVERED }}" data-target="{{ route('ecommerce.shipments.update-status', $shipment->id) }}">{{ \Platform\Ecommerce\Enums\ShippingStatusEnum::DELIVERED()->label() }}</a></li>
                                        <li><a data-value="{{ \Platform\Ecommerce\Enums\ShippingStatusEnum::NOT_DELIVERED }}" data-target="{{ route('ecommerce.shipments.update-status', $shipment->id) }}">{{ \Platform\Ecommerce\Enums\ShippingStatusEnum::NOT_DELIVERED()->label() }}</a></li>
                                        <li><a data-value="{{ \Platform\Ecommerce\Enums\ShippingStatusEnum::CANCELED }}" data-target="{{ route('ecommerce.shipments.update-status', $shipment->id) }}">{{ \Platform\Ecommerce\Enums\ShippingStatusEnum::CANCELED()->label() }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        @if ($shipment->cod_amount)
                            <div class="dropdown btn-group p-l10">
                                ...
                                <div class="dropdown dropdown-menu dropdown-ps-left applist-style animate-scale-dropdown min-width-200-px" role="menu" aria-labelledby="dropdownfilter">
                                    <div>
                                        <ul class="applist-menu">
                                            <li><a data-value="{{ \Platform\Ecommerce\Enums\ShippingCodStatusEnum::PENDING }}" data-target="{{ route('ecommerce.shipments.update-cod-status', $shipment->id) }}">{{ \Platform\Ecommerce\Enums\ShippingCodStatusEnum::PENDING()->label() }}</a></li>
                                            <li><a data-value="{{ \Platform\Ecommerce\Enums\ShippingCodStatusEnum::COMPLETED }}" data-target="{{ route('ecommerce.shipments.update-cod-status', $shipment->id) }}">{{ \Platform\Ecommerce\Enums\ShippingCodStatusEnum::COMPLETED()->label() }}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
