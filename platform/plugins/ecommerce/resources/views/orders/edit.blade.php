    ...
    <div class="max-width-1200">
        <div class="ui-layout">
            <div class="flexbox-layout-sections" id="main-order-content">
                @if ($order->status == \Platform\Ecommerce\Enums\OrderStatusEnum::CANCELED)
                ...
                <div class="flexbox-layout-section-primary mt20">
                    <div class="ui-layout__item">
                        <div class="wrapper-content">
                            ...
                            <div class="pd-all-20 border-top-title-main">
                                <div class="flexbox-grid-default flexbox-flex-wrap flexbox-align-items-center">
                                    ...
                                    @elseif ($order->payment->id)
                                        <div class="flexbox-auto-left">
                                            @if (!$order->payment->status || $order->payment->status == \Platform\Payment\Enums\PaymentStatusEnum::PENDING)
                                                <svg class="svg-next-icon svg-next-icon-size-24 svg-next-icon-gray">
                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-credit-card"></use>
                                                </svg>
                                            @elseif ($order->payment->status == \Platform\Payment\Enums\PaymentStatusEnum::COMPLETED || $order->payment->status == \Platform\Payment\Enums\PaymentStatusEnum::PENDING)
                                        ...
                                        <div class="flexbox-auto-content ml15 mr15 text-upper">
                                            ...
                                            @elseif ($order->payment->status == \Platform\Payment\Enums\PaymentStatusEnum::COMPLETED)
                                        ...
                                        @if (!$order->payment->status || in_array($order->payment->status, [\Platform\Payment\Enums\PaymentStatusEnum::PENDING]))
                                            <div class="flexbox-auto-left">
                                        ...
                                        @endif
                                        @if ($order->payment->status == \Platform\Payment\Enums\PaymentStatusEnum::COMPLETED && (($order->payment->amount - $order->payment->refunded_amount > 0) || ($order->products->sum('qty') - $order->products->sum('restock_quantity') > 0)))
                                            <div class="flexbox-auto-left">
                            ...
                            <div class="pd-all-20 border-top-title-main">
                                <div class="flexbox-grid-default flexbox-flex-wrap flexbox-align-items-center">
                                    @if ($order->status == \Platform\Ecommerce\Enums\OrderStatusEnum::CANCELED && !$order->shipment->id)
                                        <div class="flexbox-auto-left">
                                            <svg class="svg-next-icon svg-next-icon-size-20 svg-next-icon-green">
                                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-checkmark"></use>
                                            </svg>
                    ...
                    <div class="ui-layout__item">
                        ...
                        <div class="wrapper-content bg-gray-white mb20">
                            <div class="pd-all-20">
                                ...
                                @if (!in_array($order->status, [\Platform\Ecommerce\Enums\OrderStatusEnum::CANCELED, \Platform\Ecommerce\Enums\OrderStatusEnum::COMPLETED]))
