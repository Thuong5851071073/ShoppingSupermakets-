...
use Platform\Ecommerce\Forms\ProductForm;
use Platform\Ecommerce\Http\Requests\CreateProductWhenCreatingOrderRequest;
use Platform\Ecommerce\Http\Requests\ProductRequest;
use Platform\Ecommerce\Http\Requests\ProductUpdateOrderByRequest;
use Platform\Ecommerce\Http\Requests\ProductVersionRequest;
...
use Platform\Ecommerce\Services\Products\CreateProductVariationsService;
use Platform\Ecommerce\Services\Products\StoreAttributesOfProductService;
use Platform\Ecommerce\Services\Products\StoreProductService;
use Platform\Ecommerce\Services\StoreProductTagService;
use Platform\Ecommerce\Tables\ProductTable;
use Exception;
