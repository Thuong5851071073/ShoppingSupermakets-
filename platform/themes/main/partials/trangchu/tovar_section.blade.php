                            ...
                            <div class="tovar_item">
                                <div class="tovar_img">
                                    <div class="tovar_img_wrapper">
                                        <img class="img" src="{{ RvMedia::getImageUrl($product->images[0], 'featured', false, RvMedia::getDefaultImage()) }}" alt="" />
                                        <img class="img_h" src="{{ RvMedia::getImageUrl($product->images[0], 'featured', false, RvMedia::getDefaultImage()) }}" alt="" />
                                    </div>
                                    <div class="tovar_item_btns">
                                        <div class="open-project-link"><a class="open-project tovar_view" href="{{ route('product.detail', [get_category_by_id(get_category_by_product($product->id)->category_id)->slug, $product->slug]) }}" data-url="!projects/women/4.html" >xem</a></div>
                                ...
                                <div class="tovar_description clearfix">
                                    ...
                                    <span class="tovar_price">{{$product->price}} VNĐ</span>
                                </div>
                            </div>
                        </a>
                    </div><!-- //TOVAR4 --> 
