...
<p>
  ...
  <div class="container">
        ...
        <div class="table-responsiv">
            ...
            <form action="{{route('paymet.online')}}" id="create_form" method="post"> 
             @csrf
            ...
            <div class="col-4">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="order_id" name="order_id" type="text" value="{{ $order->id }}" />
                </div>
                <div class="form-group">
                    <label for="amount">Số tiền: (VNĐ)</label>
                    {{-- id="amount" --}}
                    <input class="form-control"  name="amount" type="number" value="{{ $order->sub_total}}" />
                </div>
                <div class="form-group">
