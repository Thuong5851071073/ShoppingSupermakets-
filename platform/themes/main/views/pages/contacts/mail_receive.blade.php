                                                            ...
                                                            <table align="center" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center" valign="top"
                                                                        ...
                                                                        <a href="javascript:void(0)" style="color: #fff; text-decoration: none !important;"
                                                                           target="_blank">
                                                                            <img
                                                                                    src="{{Theme::asset()->url('images/logo_bk.png')}}"
                                                                                    height="70"
                                                                                    style="max-width: 100%;display: block !important;height: auto !important;"
                                                                                    border="0"
                                                                                    hspace="0"
                                                                                    vspace="0"></a>
                                                                    </td>
                        ...
                        <table>
                            ...
                            <tr>
                                <td align="left" style="padding: 20px 50px;">
                                    <p><strong>Xin chào, Có một thông báo cho bạn từ website Tham Ty:</strong></p>
                                    <p><strong>Dear {{$input['name']}}!</strong></p>
                                    <p>Cảm ơn ông/bà <strong>{{$input['name']}}</strong>  đã quan tâm đến dịch vụ của chúng tôi</p>
