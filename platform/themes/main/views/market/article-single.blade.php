...
<div class="preloader_hide">
	...
	<div id="page">
		...
		{{-- <section class="page_header">
			...
			<!-- CONTAINER -->
			<div class="container">
				<h3 class="pull-left"><b>Article Single</b></h3>
				...
				<div class="article_single_block clearfix">
					...
					<article class="article_single clearfix">
						...
						<div class="article_image" href="article-single.html" >
							...
							<img src="images/articles/1_full.jpg" alt="" />
						</div>
						<div class="article_single_caption"><p>Be Unafraid, Self-Hosted Word- Press Is WAY Easier Nowadays</p></div>
						<div class="clear"></div>
						...
						<div class="article_single_content">
							...
							<div class="flexslider article_slider">
								<ul class="slides">
									...
									<li class="slide3">
										<img src="images/articles/slide3.jpg" />
									</li>
								</ul>
							</div>
							...
							<p>The cousin had a point. Consider Casasola’s spring/ summer 2014 lineup, which, inspired by the work of Brazilian constructivist master Lygia Clark, explores the duality of discipline and sensuality:</p>
							<p>There is something decidedly not of this century about the evening dresses—and they are almost all evening dresses, with a few soigné jumpsuits and pencil skirts in the mix—that she crafts from unembellished satins, cadys, and organzas, with hems cropped just above the ankle. “A lot of people think it makes you look shorter,” says Casasola of her preferred silhouette. “But it’s the other way around.”</p>
							...
							<div class="shared_tags_block clearfix">
