...
<div class="preloader_hide">
	...
	<div id="page">
		...
		<!-- TOP SALE -->
		<section class="top_sale parallax margbot50">
			
			<!-- CONTAINER -->
			<div class="container">
				<div class="top_sale_description">
					<p>autumn sale</p>
					<span>great men collection</span>
				</div>
				
				<!-- ROW -->
				<div class="row">
					<div class="top_sale_banners center">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-ss-12"><a class="banner nobord white_bord margbot30" href="javascript:void(0);" ><img src="images/tovar/banner6.jpg" alt="" /></a></div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-ss-12"><a class="banner nobord white_bord margbot30" href="javascript:void(0);" ><img src="images/tovar/banner7.jpg" alt="" /></a></div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-ss-12"><a class="banner nobord white_bord margbot30" href="javascript:void(0);" ><img src="images/tovar/banner8.jpg" alt="" /></a></div>
						
						<div class="respond_clear_1024 respond_clear_768 respond_clear_480"></div>
						
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-ss-12"><a class="banner nobord white_bord margbot30" href="javascript:void(0);" ><img src="images/tovar/banner9.jpg" alt="" /></a></div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-ss-12"><a class="banner nobord white_bord margbot30" href="javascript:void(0);" ><img src="images/tovar/banner10.jpg" alt="" /></a></div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-ss-12"><a class="banner nobord white_bord margbot30" href="javascript:void(0);" ><img src="images/tovar/banner11.jpg" alt="" /></a></div>
					</div>
				</div><!-- //ROW -->
			</div><!-- //CONTAINER -->
		</section><!-- //TOP SALE -->
		...
		<!-- BRANDS -->
		<section class="brands_carousel padbot20">
