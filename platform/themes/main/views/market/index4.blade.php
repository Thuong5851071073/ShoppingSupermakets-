...
<div class="preloader_hide">
	...
	<div id="page">
							...
							<ul class="mega_menu megamenu_col1 clearfix">
								<li class="col">
									<ol>
										...
										<li class="active"><a href="index4.html" >Home video</a></li>
		...
		<!-- FASHION WEEK -->
		<section class="fashion_week parallax margbot50">
			
			<!-- CONTAINER -->
			<div class="container">
				<div class="fashion_week_description">
					<p><b>fashion</b> Week</p>
					<span>the best brands from around the world</span>
				</div>
				
				
				<!-- VIDEO BLOCK -->
				<div class="video_wrapper">
					<div class="video_container" data-video="http://www.youtube.com/embed/GfX0753bUEE?version=3&amp;hl=en_US&amp;autoplay=1">
		...
		<section class="best_products padbot60">
			...
			<!-- CONTAINER -->
			<div class="container">
				<h2>See the best deals on products this week</h2>
		...
		<!-- BRANDS -->
		<section class="brands_carousel padbot40">
		...
		<!-- BANNER SECTION -->
		<section class="banner_section padbot40">
			...
			<div class="container" data-appear-top-offset='-100' data-animated='fadeInUp'>
				...
				<div class="row">
					<div class="top_sale_banners center">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-ss-12"><a class="banner nobord margbot30" href="javascript:void(0);" ><img src="images/tovar/banner6.jpg" alt="" /></a></div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-ss-12"><a class="banner nobord margbot30" href="javascript:void(0);" ><img src="images/tovar/banner8.jpg" alt="" /></a></div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-ss-12"><a class="banner nobord margbot30" href="javascript:void(0);" ><img src="images/tovar/banner9.jpg" alt="" /></a></div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-ss-12"><a class="banner nobord margbot30" href="javascript:void(0);" ><img src="images/tovar/banner10.jpg" alt="" /></a></div>
					</div>
				</div><!-- //ROW -->
			</div><!-- //CONTAINER -->
