							...
							<ul class="mega_menu megamenu_col3 clearfix">
								...
								<li class="col">
									<ol>
										...
										<li class="active"><a href="update.html" >Site Update</a></li>
		...
		<section class="update_page parallax">
			...
			<div class="container">
				<div class="update_wrapper">
					<h1>UPDATE</h1>
					<h2>we update our store</h2>
					<p>before the opening of the store left</p>
...
<div id="modal-body" class="clearfix">
	...
	<script>
		jQuery(document).ready(function() {
			$('#countdown-clock').FlipClock(new Date(2015, 07, 18).getTime() / 1000 - new Date().getTime() / 1000, {
