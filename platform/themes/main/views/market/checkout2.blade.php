					...
					<div class="checkout_delivery clearfix">
						...
						<ul>                
							...
							<li>
								...
								<label for="ridio2">Excluseve International Post <b>Postage $ 10 (2-4 week)</b><img src="images/excluseve_post.jpg" alt="" /></label>
							</li>
							<li>
								<input id="ridio3" type="radio" name="radio" hidden />
								<label for="ridio3">Premium Post <b>Postage $ 50 (1-2 week)</b><img src="images/premium_post.jpg" alt="" /></label>
							</li>
							<li>
								<input id="ridio4" type="radio" name="radio" hidden />
								<label for="ridio4">For VIP clients <b>$ 100 (3 days)</b><img src="images/vip_post.jpg" alt="" /></label>
							</li>
						</ul>
						...
						<a class="btn active pull-right checkout_block_btn" href="checkout3.html" >Continue</a>
					</div>
				</div><!-- //CHECKOUT BLOCK -->
			</div><!-- //CONTAINER -->
